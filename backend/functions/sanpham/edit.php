    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class=" col-md-10 ml-sm-auto px-4 mb-2">
                <div>
                    <h1 class="h2">Sửa thông tin Sản phẩm</h1>
                </div>
                ...
                // SELECT SAN PHAM --------------------
                $sql_sp = <<<EOT
                SELECT sp_ma, sp_ten, sp_gia, sp_giacu, sp_mota_ngan, sp_mota_chitiet, sp_ngaycapnhat, sp_soluong, lsp_ma, nsx_ma, km_ma
	                FROM sanpham
                    WHERE sp_ma = $sp_ma;
EOT;
                $result_sp = mysqli_query($conn, $sql_sp);
                $data_sp = mysqli_fetch_array($result_sp, MYSQLI_ASSOC);

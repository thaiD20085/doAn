  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main role="main" class="col-md-10 ml-sm-auto px-4 mb-2">
        ...
        $sqlhsp = "SELECT * FROM hinhsanpham WHERE hsp_ma = $hsp_ma";
        $resulthql = mysqli_query($conn, $sqlhsp);
        $rowhql = mysqli_fetch_array($resulthql, MYSQLI_ASSOC);
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="sp_ma" name="sp_ma">
              <?php foreach ($dataSanPham as $sanpham) : ?>
                <option value="<?= $sanpham['sp_ma'] ?>" <?php if($sanpham['sp_ma']==$rowhql['sp_ma']) echo ' selected';?>><?= $sanpham['sp_tomtat'] ?></option>
              <?php endforeach; ?>
            </select>
          </div>
          <div class="form-group">
            ...
            <div class="preview-img-container">
              <img src="/hocPHP-CP20SCF26/assets/uploads/products/<?= $rowhql['hsp_tentaptin']?>" id="preview-img" width="200px" />
            </div>

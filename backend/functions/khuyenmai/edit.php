...
EOT;
                ...
                <form action="" method="post" name="frmCreate" id="frmCreate">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="km_ma" id="km_ma" value="<?=$km_ma?>" readonly>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-lg">
                            <div class="form-group">
                                <label for="km_ten">Tên</label>
                                <input type="text" class="form-control" name="km_ten" id="km_ten" value="<?=$data['km_ten']?>">
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md">
                                    <label for="km_tungay">Ngày bắt đầu</label>
                                    <input type="text" class="form-control" name="km_tungay" id="km_tungay" value="<?=$data['km_tungay']?>">
                                </div>
                                <div class="form-group col-md">
                                    <label for="km_denngay">Ngày bắt đầu</label>
                                    <input type="text" class="form-control" name="km_denngay" id="km_denngay" value="<?=$data['km_denngay']?>"> 
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-lg">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" name="km_noidung" id="km_noidung"><?=$data['km_noidung']?></textarea>
                            </div>
                        </div>
                    </div>

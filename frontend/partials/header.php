            ...
            <div class="container w-100">
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav mr-auto nav-top">
                        ...
                        <li class="nav-item">
                            <a href="#" class="px-2 py-3">Tìm cửa hàng</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="px-2 py-3">Kiểm tra đơn hàng</a>
                        </li>
                    </ul>
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item pl-4">
                            <a class="nav-link btn btn-sm font-weight-bold py-1" href="pages/signin.html">ĐĂNG NHẬP </a>
                        </li>
                        <li class="nav-item d-tablet-none">
                            <a class="nav-link btn btn-primary btn-sm font-weight-bold py-1" style="color:white;" href="#">ĐĂNG KÝ</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="container w-100">
                ...
                <div class="collapse navbar-collapse ml-3" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto font-weight-bold nav-bottom">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="pages/oto.html">LINH KIỆN</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-tablet-block" href="#">ĐĂNG NHẬP </a>
                        </li>
                        <li class="nav-item d-tablet-block">
                            <a class="nav-link d-tablet-block" href="#">ĐĂNG KÝ</a>
                        </li>
                    </ul>
